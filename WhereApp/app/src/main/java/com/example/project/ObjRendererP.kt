...
class ObjRendererP(private val mContext: Context, private val mObjName: String, private val mTextureName: String
) {
...
void main() {
    ...
    companion object {
        private val TAG = ObjRendererP::class.java.simpleName
    }
}