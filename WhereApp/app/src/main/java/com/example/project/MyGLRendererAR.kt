...
class MyGLRendererAR(private  val mContext: ARCamera):GLSurfaceView.Renderer {
    ...
    //생성자
    init {
        mCamera = CarmeraRendererAR()

        obj = ObjRendererAR(mContext,"andy.obj","andy.png")
    ...
    override fun onSurfaceCreated(gl: GL10?, config: EGLConfig?) {
        ...
        obj.init()
        if(mContext.myMapFragAR != null){
            mContext.myMapFragAR!!.places.obj.init()
        }
    ...
    override fun onDrawFrame(gl: GL10?) {
        ...
        if(mContext.myMapFragAR != null){
            mContext.myMapFragAR!!.places.obj.draw()
        }
    ...
    fun updateViewMatrix(matrix: FloatArray){
        ...
        if(mContext.myMapFragAR != null){
             mContext.myMapFragAR!!.places.obj.setViewMatrix(matrix)
        }
    ...
    fun updateProjMatrix(matrix: FloatArray){
        ...
        if(mContext.myMapFragAR != null){
            mContext.myMapFragAR!!.places.obj.setProjectionMatrix(matrix)
        }
    }
