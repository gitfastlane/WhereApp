...
class ObjRendererAR(private val mContext: Context, private val mObjName: String, private val mTextureName: String
) {
...
void main() {
    ...
    companion object {
        private val TAG = ObjRendererAR::class.java.simpleName
    }
}