...
class MyMapFragC(var mainActivity:HomeChild, var googleMap:GoogleMap) {
    ...
    init{
        ...
        Log.d("myMapFrag 여","${mapPin.latitude}")
        Log.d("myMapFrag 여","${mapPin.longitude}")
        places = mapPin!!.makePlaces(mainActivity)
        ...
        */
        earth = mainActivity.mSession!!.earth!!
